      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-5xl font-abhaya mb-6">Meet Chef Saurabh</h2>
            <p className="font-abhaya text-lg leading-relaxed mb-6">
              With over 15 years of experience in Rajasthani cuisine, Chef Saurabh brings the authentic flavors of royal kitchens to your plate. His innovative approach combines traditional recipes with modern presentation.
            </p>
            <div className="aspect-video rounded-lg overflow-hidden">
              <video 
                ...
                playsInline
              >
                <source src="/chef-video.mp4" type="video/mp4" />
              </video>
            </div>
          </motion.div>
          <motion.div
        ...
        <svg 
          className="absolute bottom-0 left-0 w-1/2 h-2/3 text-pink-300"
          viewBox="0 0 512 512" 
